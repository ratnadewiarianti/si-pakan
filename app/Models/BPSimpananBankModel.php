...
class BPSimpananBankModel extends Model
{
    ...
    {
        return $this->select('bp_simpanan_bank.tanggal, bp_simpanan_bank.tgl_selesai, bp_simpanan_bank.tgl_mulai, bp_simpanan_bank.kepala_dinas, bp_simpanan_bank.bendahara_pengeluaran,
