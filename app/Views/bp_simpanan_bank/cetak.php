    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div>
                ...
                <div class="title1">BUKU PEMBANTU SIMPANAN BANK</div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-12">
                <table class="table table-bordered" style="text-align: left; border-color:black;">
                    ...
                    <tbody>
                        <?php $current_balance = $saldo_awal; 
                        ?>
                        <tr>
                            <td>1</td>
                            <td><?= (new DateTime($tgl_awal))->format('d/m/Y') ?></td>
                            <td></td>
                            <td>Saldo Awal</td>
                            <td></td>
                            <td></td>
                        ...
                        <?php foreach ($data as $row) : ?>
                            ...
                            <?php else : ?>
                                <?php $current_balance += $row['penerimaan']; ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td></td>
                                    <td></td>
                                    <td><?= $row['uraian'] ?></td>
                                    <td></td>
                                    <td><?= number_format($row['penerimaan'], 2, ',', '.') ?></td>
                                    <td>-</td>
                                    <td><?= number_format($current_balance, 2, ',', '.') ?></td>
                                </tr>
                                <?php $current_balance -= $row['pengeluaran']; ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td></td>
                                    <td></td>
