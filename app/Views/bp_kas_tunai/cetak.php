...
<body class="bg-light">
    ...
    if (!empty($bp_kas_tunai)) {
        $tanggal_formatted = isset($bp_kas_tunai[0]['tanggal']) ? formatTanggalIndonesia($bp_kas_tunai[0]['tanggal'], $bulan) : 'Tanggal tidak ditemukan';
        $tgl_mulai_formatted = isset($bp_kas_tunai[0]['tgl_mulai']) ? formatTanggalIndonesia($bp_kas_tunai[0]['tgl_mulai'], $bulan) : 'Tanggal mulai tidak ditemukan';
        $tgl_selesai_formatted = isset($bp_kas_tunai[0]['tgl_selesai']) ? formatTanggalIndonesia($bp_kas_tunai[0]['tgl_selesai'], $bulan) : 'Tanggal selesai tidak ditemukan';
    } else {
    ...
    <div class="container">
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                ...
                <div class="sub-title2"><b><?= $bp_kas_tunai[0]['jabatan_kepala_dinas']; ?></b></div>
            </div>

            <div class="col-md-6">
                <div class="sub-title2">Pelaihari, <?= $tanggal_formatted; ?></div>
                <div class="sub-title2"><b><?= $bp_kas_tunai[0]['jabatan_bendahara']; ?></b></div>
            </div>
        </div>

        <div class="row mt-3">
            <div class="col-md-6 text-center">
                <?php if (!empty($bp_kas_tunai[0]['ttd_kepala_dinas'])) : ?>
                <img src="<?= base_url('uploads/ttd/' . $bp_kas_tunai[0]['ttd_kepala_dinas']) ?>" alt="Gambar"
            ...
            <div class="col-md-6 text-center">
                <?php if (!empty($bp_kas_tunai[0]['ttd_bendahara'])) : ?>
                <img src="<?= base_url('uploads/ttd/' . $bp_kas_tunai[0]['ttd_bendahara']) ?>" alt="Gambar" width="100"
                    height="100">
                <?php else : ?>
                -
                <?php endif; ?>
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                <div class="sub-title2"><?= $bp_kas_tunai[0]['kepala_dinas_nama']; ?></div>
            </div>

            <div class="col-md-6">
                <div class="sub-title2"><?= $bp_kas_tunai[0]['bendahara_nama']; ?></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="sub-title2">NIP. <?= $bp_kas_tunai[0]['kepala_dinas']; ?></div>
            </div>

            <div class="col-md-6">
                <div class="sub-title2">NIP. <?= $bp_kas_tunai[0]['bendahara_pengeluaran']; ?></div>
            </div>
        </div>
